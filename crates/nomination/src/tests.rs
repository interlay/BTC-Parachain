...
fn should_deposit_against_valid_vault() {
    run_test(|| {
        ...
        ext::vault_registry::get_vault_total_collateral::<Test>.mock_safe(|_| MockResult::Return(Ok(10000)));
        ext::vault_registry::get_vault_collateral::<Test>.mock_safe(|_| MockResult::Return(Ok(10000)));
